...
public class SignUpRequest extends RetrofitSpiceRequest<SignUpJson, SignUpRequest.Webservice> {
	...
	@Override
	public SignUpJson loadDataFromNetwork() throws Exception {
		...
		hmac = computeHmac(email, passhash, name, repo, String.valueOf(privacy), privacy_user, privacy_pass, update);
	...
	public interface Webservice {
		...
		@FormUrlEncoded
		@POST("/2/createUser")
		SignUpJson signUp(@FieldMap Map<String, Object> params);
	}
}
