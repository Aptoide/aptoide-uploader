 ...
 */
public class GetApkInfoRequest
    extends RetrofitSpiceRequest<GetApkInfoJson, GetApkInfoRequest.Webservice> {
  ...
  @Override public GetApkInfoJson loadDataFromNetwork() throws Exception {
    ...
    if (apkPath != null) {
      ...
      parameters.put("identif", "package:" + apkid);
    }
  ...
  public interface Webservice {
    ...
    @FormUrlEncoded @POST("/3/getApkInfo") GetApkInfoJson getApkInfo(
