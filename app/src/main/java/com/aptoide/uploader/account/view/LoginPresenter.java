...
public class LoginPresenter implements Presenter {
  ...
  public LoginPresenter(LoginView view, AptoideAccountManager accountManager,
      ...
      Scheduler viewScheduler, AccountPermissionProvider accountPermissionProvider) {
    this.view = view;
  ...
  @Override public void present() {
    ...
    compositeDisposable.add(view.getLifecycleEvent()
        ...
        .flatMap(__ -> accountPermissionProvider.permissionResultGetAccounts()
            .flatMap(__1 -> accountManager.getAccount())
    ...
    compositeDisposable.add(view.getLifecycleEvent()
        .filter(event -> event.equals(View.LifecycleEvent.CREATE))
        .doOnNext(__ -> accountPermissionProvider.requestGetAccountPermission())
        .observeOn(viewScheduler)
        .subscribe(__ -> {
        }, throwable -> {
          throw new OnErrorNotImplementedException(throwable);
