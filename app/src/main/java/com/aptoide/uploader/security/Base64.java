 ...
 * <p>
 * <p>Note {@link } is a GWT-compatible implementation of this class.
 */
public class Base64 {
   ...
   * bytes to <var>destination</var>. The source and destination arrays can be
   ...
   * enough to
   * accommodate <var>srcOffset</var> + 3 for the <var>source</var> array or <var>destOffset</var> +
   ...
   * them) to <var>destination</var>. The source and destination arrays can be
   * manipulated anywhere along their length by specifying <var>srcOffset</var> and
   * <var>destOffset</var>. This method does not check to make sure your arrays are large
   * enough to
   * accommodate <var>srcOffset</var> + 4 for the <var>source</var> array or <var>destOffset</var> +
   * 3 for the <var>destination</var> array. This method returns the actual
   * number
