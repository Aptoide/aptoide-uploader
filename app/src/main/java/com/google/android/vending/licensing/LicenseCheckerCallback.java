 ...
 * <p>
 * <b>The callback does not occur in the original checking thread.</b> Your application should post to the appropriate handling thread or lock accordingly.
 * <p>
 * The reason that is passed back with allow/dontAllow is the base status handed to the policy for allowed/disallowing the license. Policy.RETRY will call allow or dontAllow
 * depending on other statistics associated with the policy, while in most cases Policy.NOT_LICENSED will call dontAllow and Policy.LICENSED will Allow.
 */
public interface LicenseCheckerCallback {
	 ...
	 *
	 * @param reason Policy.NOT_LICENSED or Policy.RETRY. (although in theory the policy can return Policy.LICENSED here as well --- perhaps the call to the LVL took too long, for
	 *               example)
	 */
