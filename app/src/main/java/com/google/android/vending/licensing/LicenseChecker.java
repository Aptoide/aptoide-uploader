 ...
 * whether a user should have access to the application. For example, the Policy can
 * define a threshold for allowable number of server or client failures before the library reports
 * the user as not having access.
 * <p>
...
public class LicenseChecker implements ServiceConnection {
   ...
   * recommend obfuscating the string that is passed into bindService using another
  ...
  public synchronized void checkAccess(LicenseCheckerCallback callback) {
    ...
    if (mPolicy.allowAccess()) {
      ...
      LicenseValidator validator =
          new LicenseValidator(mPolicy, new NullDeviceLimiter(), callback, generateNonce(),
   ...
   * screen rotation if an Activity requests the license check or when the user
