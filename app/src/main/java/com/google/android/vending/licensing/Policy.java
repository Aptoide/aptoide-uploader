...
public interface Policy {
	...
	/**
	 * Provide results from contact with the license server. Retry counts are incremented if the current value of response is RETRY. Results will be used for any future policy
	 * decisions.
	 *
