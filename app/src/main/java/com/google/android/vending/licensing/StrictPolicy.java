 ...
 * performed.
 * <p>
 * Using a non-caching policy ensures that there is no local preference data for malicious users to
 * tamper with. As a side effect, applications will not be permitted to run while
 * offline. Developers should carefully weigh the risks of using this Policy over one which
 * implements caching, such as ServerManagedPolicy.
 * <p>
 * Access to the application is only allowed if a LICESNED response is. received. All other
...
public class StrictPolicy implements Policy {
   ...
   * {@inheritDoc}
   * <p>
   * This implementation allows access if and only if a LICENSED response was received the last time
